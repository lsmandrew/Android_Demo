...
public class ConstantUtil {
    ...
    public static final String HOST_WEB = "http://www.xyzdd.com";

    // APK 升级
    public static final String HTTP_APK_JSON = "version.json";
    public static final String HTTP_APK_Name = "app-release.apk";

    // 日志 提交到服务器URL
    public static final String LOG_URL = HOST_WEB + "/uploadServlet";
    // 崩溃日志 提交到服务器URL
    public static final String CARSH_LOG_URL = HOST_WEB + "/AndroidCarshLog/";
    // 崩溃日志 SD卡文件夹路径
    public static final String DIR_LOG = "TouristLog";


    // 入住
    public static final String ROOM_IN = "1";
    // 退房
    public static final String ROOM_OUT = "0";

    public static long PAGE_COUNT = 7;
